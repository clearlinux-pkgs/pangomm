...
Source0  : https://download.gnome.org/sources/pangomm/2.50/pangomm-2.50.0.tar.xz
...
%prep
%setup -q -n pangomm-2.50.0
cd %{_builddir}/pangomm-2.50.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638826571
...
cp %{_builddir}/pangomm-2.50.0/COPYING %{buildroot}/usr/share/package-licenses/pangomm/cf756914ec51f52f9c121be247bfda232dc6afd2
cp %{_builddir}/pangomm-2.50.0/COPYING.tools %{buildroot}/usr/share/package-licenses/pangomm/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
