...
Source0  : https://download.gnome.org/sources/pangomm/2.54/pangomm-2.54.0.tar.xz
...
%prep
%setup -q -n pangomm-2.54.0
cd %{_builddir}/pangomm-2.54.0
pushd ..
cp -a pangomm-2.54.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721926507
