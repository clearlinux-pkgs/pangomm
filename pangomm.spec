...
Source0  : https://download.gnome.org/sources/pangomm/2.56/pangomm-2.56.1.tar.xz
...
%prep
%setup -q -n pangomm-2.56.1
cd %{_builddir}/pangomm-2.56.1
pushd ..
cp -a pangomm-2.56.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736975649
