...
Source0  : https://download.gnome.org/sources/pangomm/2.50/pangomm-2.50.2.tar.xz
...
%prep
%setup -q -n pangomm-2.50.2
cd %{_builddir}/pangomm-2.50.2
pushd ..
cp -a pangomm-2.50.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706543867
