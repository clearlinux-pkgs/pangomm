...
Source0  : https://download.gnome.org/sources/pangomm/2.48/pangomm-2.48.1.tar.xz
...
%prep
%setup -q -n pangomm-2.48.1
cd %{_builddir}/pangomm-2.48.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621607336
...
cp %{_builddir}/pangomm-2.48.1/COPYING %{buildroot}/usr/share/package-licenses/pangomm/cf756914ec51f52f9c121be247bfda232dc6afd2
cp %{_builddir}/pangomm-2.48.1/COPYING.tools %{buildroot}/usr/share/package-licenses/pangomm/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
